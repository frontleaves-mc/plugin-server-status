...
public class EventListener implements Listener {
    ...
    @Contract(pure = true)
    public EventListener(@NotNull JavaPlugin plugin, @NotNull StatusGrpcService grpcService) {
        this.plugin = plugin;
    ...
    public void onPlayerJoin(@NotNull PlayerJoinEvent event) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> grpcService.playerJoin(uuid, name, worldName));
    }
